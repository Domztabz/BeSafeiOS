...
struct TracerRemoteConfig {
    static let defaultShareText = """
        Join me in stopping the spread of COVID-19! Download COVIDSafe, an app from the Kenyan Government. #COVID19
        #coronaviruskenya #stayhomesavelives https://www.health.go.ke/
        """
}
